...
- Add Books: Click on the "Add Book" button in each shelf (Want to Read, Currently Reading, Finished Reading) to add a new book. Enter the book's details such as title, author, date of publication, and genre. The book will be added to the corresponding shelf.
